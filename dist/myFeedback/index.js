    ...
    render: function render() {
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'div',
                    { className: 'my-message my-setting' },
                    React.createElement(
                        'ul',
                        { className: 'am-list am-list-static feedback-list' },
                        React.createElement(
                            'li',
                            null,
                            React.createElement(
                                'a',
                                { href: '../myFeedbackDetail' },
                                React.createElement('i', { className: 'am-icon-stethoscope am-icon-sm icon-left' }),
                                '\u5C31\u8BCA\u53CD\u9988',
                                React.createElement('i', { className: 'am-icon-angle-right am-icon-sm' })
                            )
                        ),
                        React.createElement(
                            'li',
                            ...
                            React.createElement(
                                'a',
                                { href: '../myFeedbackList' },
                                React.createElement('i', { className: 'am-icon-list-alt am-icon-sm icon-left' }),
                                '\u6D88\u606F\u5217\u8868',
                                React.createElement('i', { className: 'am-icon-angle-right am-icon-sm' })
                            )
                        )
