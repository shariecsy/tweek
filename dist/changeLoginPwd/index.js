			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement('input', { type: 'password', name: 'oldPassword', className: 'registered-input', placeholder: '\u8BF7\u8F93\u5165\u539F\u5BC6\u7801' })
					),
					React.createElement(
						'p',
						{ className: 'reg-list' },
						...
						React.createElement('input', { type: 'password', name: 'newPassword', className: 'registered-input', placeholder: '\u8BF7\u8F93\u51656-16\u4F4D\u65B0\u5BC6\u7801' })
					),
					React.createElement(
						'p',
						{ className: 'reg-list' },
						...
						React.createElement('input', { type: 'password', name: 'confirmNewPassword', className: 'registered-input', placeholder: '\u8BF7\u91CD\u65B0\u8F93\u51656-16\u4F4D\u786E\u8BA4\u65B0\u5BC6\u7801' })
					)
				),
				React.createElement(
					'div',
